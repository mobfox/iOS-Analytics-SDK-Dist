#
# Be sure to run `pod lib lint MobFoxAnalyticsSDKDynamic.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = "MobFoxAnalyticsSDKDynamic"
  s.version          = "3.6.6"
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.frameworks = 'MobFoxAnalyticsSDKDynamic'
